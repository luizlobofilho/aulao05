...
import com.devsuperior.myfirstproject.entites.Category;
import com.devsuperior.myfirstproject.entites.Product;
...
public class MyfirstprojectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(1L,"TV", 2220.0, cat1);
		Product p2 = new Product(2L, "Domain Driven Design", 120.0, cat2);
		Product p3 = new Product( 3L, "PS5", 4900.00, cat1);
